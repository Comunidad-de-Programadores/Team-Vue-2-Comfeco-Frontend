    ...
    methods: {
        async registrando() {
            ...
            if (this.$v.$invalid) {
                ...
                let response = await this.service.Register(
                    this.name,
                    this.email,
                    this.password,
                ...
                if (!response.data.error) {
                    ...
                    this.submitStatus = "ERROR";
                    response.data.errors.password_confirmation.length > 0 &&
                    ...
                    response.data.errors.name.length > 0 &&
                        this.validationTexts.push(response.data.errors.name);
                    response.data.errors.email.length > 0 &&
                        this.validationTexts.push(response.data.errors.email);
                }
            }
        }
    }
