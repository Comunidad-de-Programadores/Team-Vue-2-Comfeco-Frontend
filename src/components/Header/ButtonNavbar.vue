        ...
        div
            div(class="dropdown inline-block relative")
                button(class="bg-gray-300 text-gray-700 font-semibold py-2 pl-4 rounded-l-3xl rounded inline-flex items-center" )
                    ...
                    p(class="text-xs w-32") Luis David Padron Millan
                ...
                ul( class="dropdown-menu absolute hidden text-gray-700 pt-1 z-10")
                    li(class="")
                        a(class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-16 block whitespace-no-wrap" href="#" @click="logout()") Logout
                    li(class="")
                        a(class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-16 block whitespace-no-wrap" href="#") Two
                    li(class="")
                        a(class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-16 block whitespace-no-wrap" href="#") Three
